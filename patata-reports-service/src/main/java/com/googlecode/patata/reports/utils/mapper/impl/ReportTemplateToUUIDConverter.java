...
import com.googlecode.patata.reports.utils.mapper.IReportTemplateToUUIDConverter;
 ...
 * @date Aug 5, 2014
 */
public class ReportTemplateToUUIDConverter extends AbstractCustomConverter<ReportTemplate, ReportTemplateDto, String, UUID>
